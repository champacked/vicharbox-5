                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                      ...
                      <div className="space-y-1 text-center">
                        {imagePreview != undefined ? (
                          <div className="relative">
                            ...
                            <X
                              size={16}
                              className="absolute text-white top-0 right-0 mt-2 mr-2 cursor-pointer"
                              onClick={changeImg}
                            />
                          </div>
                        ) : (
                  ...
                  <div className=" flex justify-end items-center   pt-5">
                    ...
                    <button
                      disabled={loading}
                      type="submit"
                      className="mx-12 px-5 py-2.5 relative rounded group  text-white font-medium inline-block"
                    >
                    ...
                    <button
                      onClick={deleteBlog}
                      className="relative w-36 inline-flex h-12 overflow-hidden rounded-xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
                    >
